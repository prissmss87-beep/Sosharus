    ...
    return (
        <div>
            ...
            <div className={styles.divisao}>
                <h1 className={styles.texto}>My Profile</h1>
            </div>
            ...
            <div className={styles.parte}>
                <div className={styles.inputs}>
                    ...
                    <input className={styles.msc} placeholder='Music Link' value={music} onChange={e => setMusic(e.target.value)} />
                    ...
                    <p className={styles.maita}>
                        Public Profile: {user.profileUrl
                            ? `http://localhost:5173/u/${user.profileUrl}`
                            : "Not Defined"}
                    </p>
